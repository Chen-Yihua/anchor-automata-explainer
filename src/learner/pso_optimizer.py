        ...
        **kwargs : dict
        ...
        for particle_id in range(n_particles):
            try:
                ...
                # Increment evaluation counter (one objective evaluation ≈ one candidate evaluated)
                ...
                if self.verbose:
                    print(f"  [ERROR] Particle {particle_id} evaluation failed: {e}")
                losses[particle_id] = float('inf')
