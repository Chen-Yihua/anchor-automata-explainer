...
from datasets.Wafer_loader import load_Wafer_sequences
...
def main():
    ...
    use_paa = True
    n_segments = 30                   # compress raw length 152 -> 30
    compress = False                  # keep False if you want exact length 30
    pad_to_length = None              # set 30 only if compress=True and you still want exact length 30
