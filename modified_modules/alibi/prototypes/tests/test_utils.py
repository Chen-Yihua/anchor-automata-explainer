import pytest
import numpy as np
from modified_modules.alibi.utils.distance import squared_pairwise_distance, batch_compute_kernel_matrix
from modified_modules.alibi.utils.kernel import GaussianRBF, GaussianRBFDistance, EuclideanDistance
