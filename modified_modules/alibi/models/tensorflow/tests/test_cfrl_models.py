import numpy as np
import pytest
from modified_modules.models.tensorflow.autoencoder import AE, HeAE
from modified_modules.models.tensorflow.cfrl_models import (ADULTDecoder, ADULTEncoder,
