...
from modified_modules.alibi.explainers.backends.cfrl_tabular import (get_conditional_vector,
                                                    get_statistics, sample)
from modified_modules.alibi.explainers.cfrl_base import (_PARAM_TYPES, CounterfactualRL,
                                        Postprocessing)
from modified_modules.alibi.utils.frameworks import has_pytorch, has_tensorflow
...
if has_pytorch:
    ...
    from modified_modules.alibi.explainers.backends.pytorch import cfrl_tabular as pytorch_tabular_backend

if has_tensorflow:
    # import tensorflow backend
    from modified_modules.alibi.explainers.backends.tensorflow import cfrl_tabular as tensorflow_tabular_backend
