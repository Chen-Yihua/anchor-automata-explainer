...
from modified_modules.alibi.api.defaults import DEFAULT_DATA_CFRL, DEFAULT_META_CFRL
from modified_modules.alibi.api.interfaces import Explainer, Explanation, FitMixin
from modified_modules.alibi.explainers.backends.cfrl_base import (generate_empty_condition,
                                                 get_classification_reward,
                                                 get_hard_distribution,
                                                 identity_function)
from modified_modules.alibi.utils.frameworks import Framework, has_pytorch, has_tensorflow
...
if has_pytorch:
    ...
    from modified_modules.alibi.explainers.backends.pytorch import cfrl_base as pytorch_base_backend

if has_tensorflow:
    # import tensorflow backend
    from modified_modules.alibi.explainers.backends.tensorflow import cfrl_base as tensorflow_base_backend
    ...
    def __init__(self,
        ...
        **kwargs
        ...
        if self.params["backend"] == Framework.PYTORCH:
            from modified_modules.explainers.backends.pytorch.cfrl_base import get_device
