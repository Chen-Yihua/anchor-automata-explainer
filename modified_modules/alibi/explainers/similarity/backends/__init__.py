...
if has_pytorch:
    ...
    from modified_modules.alibi.explainers.similarity.backends.pytorch.base import \
        _PytorchBackend

if has_tensorflow:
    # import tensorflow backend
    from modified_modules.alibi.explainers.similarity.backends.tensorflow.base import \
        _TensorFlowBackend
