...
from modified_modules.alibi.saving import load_explainer
from modified_modules.alibi.alibi_testing.data import get_adult_data, get_iris_data, get_movie_sentiment_data
import modified_modules_testing
from modified_modules.alibi.utils.download import spacy_model
from modified_modules.alibi.explainers.tests.utils import predict_fcn
...
@pytest.fixture(scope='module')
def language_model():
    from modified_modules.utils.lang_model import DistilbertBaseUncased
...
def iris_ae(iris_data):
    from modified_modules.models.tensorflow.autoencoder import AE
